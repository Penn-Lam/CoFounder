...
- Default the production Jev confidence threshold to `0.3`, calibrated against 81 deterministic boundary fixtures and 20 approved narrative mocks. Re-run the calibration before changing the pinned model, decision schema, candidate criteria, or threshold.
